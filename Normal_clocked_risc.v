...
always @(*) begin
    ...
    case(state)
        ...
        else if(opcode == BNE && !zero) jmp = 1; end
...
module data_memory(input [15:0]address,input clk,mem_rd,mem_wt,
...
always @(*) begin
        case (opcode)
            ...
            4'b1100: {carry,ALU_op} = rx_value-ry_value;      //BEQ
            4'b1101: {carry,ALU_op}=rx_value-ry_value;        //BNE      
